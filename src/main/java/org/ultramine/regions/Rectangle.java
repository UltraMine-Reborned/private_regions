...
public class Rectangle {
    ...
    public Rectangle setSide(ForgeDirection dir, int amount) {
        switch (dir) {
            case DOWN:
                return new Rectangle(new BlockPos(min.x, amount, min.z), max);
            case NORTH:
                return new Rectangle(new BlockPos(min.x, min.y, amount), max);
            case WEST:
                return new Rectangle(new BlockPos(amount, min.y, min.z), max);
            case UP:
                return new Rectangle(min, new BlockPos(max.x, amount, max.z));
            case SOUTH:
                return new Rectangle(min, new BlockPos(max.x, max.y, amount));
            case EAST:
                return new Rectangle(min, new BlockPos(amount, max.y, max.z));
            case UNKNOWN:
                throw new IllegalArgumentException("UNKNOWN direction");
        }
    ...
    public Rectangle expand(ForgeDirection dir, int amount) {
        switch (dir) {
            case DOWN:
                return new Rectangle(new BlockPos(min.x, min.y - amount, min.z), max);
            case NORTH:
                return new Rectangle(new BlockPos(min.x, min.y, min.z - amount), max);
            case WEST:
                return new Rectangle(new BlockPos(min.x - amount, min.y, min.z), max);
            case UP:
                return new Rectangle(min, new BlockPos(max.x, max.y + amount, max.z));
            case SOUTH:
                return new Rectangle(min, new BlockPos(max.x, max.y, max.z + amount));
            case EAST:
                return new Rectangle(min, new BlockPos(max.x + amount, max.y, max.z));
            case UNKNOWN:
                throw new IllegalArgumentException("UNKNOWN direction");
        }
