...
import org.ultramine.mods.privreg.regions.*;
...
public class TileBlockRegion extends TileEntity implements ITEPacketHandler<PacketTEBlockRegion>, IHasGui {
    ...
    public IGui getGui(int id, EntityPlayer player) {
        switch (id) {
            case GUI_MAIN_ID:
                return new GuiBlockRegion(this, player);
            case GUI_MODULES_ID:
                return new GuiRegionModules(player, region);
        }
        return null;
    }
    ...
    public Container getGuiContainer(int id, EntityPlayer player) {
        switch (id) {
            case GUI_MAIN_ID:
                return new ContainerBlockRegion(this);
            case GUI_MODULES_ID:
                return new ContainerRegionModules(player.inventory, region);
        }
        return null;
    }
